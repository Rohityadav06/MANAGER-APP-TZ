...
import { NavController, ModalController, LoadingController, AlertController, MenuController } from '@ionic/angular';
...
@Component({
  selector: 'app-signin-manager',
  templateUrl: './signin-manager.page.html',
  styleUrls: ['./signin-manager.page.scss'],
})
export class SigninManagerPage implements OnInit {
